...
function preload(){
  ...
  gameOverImg = loadImage("assets/GO.gif");
...
function draw() {
  ...
  strokeWeight(5);
  fill("green");
  text("In order to win try to collect atleast 5 shrubs",10,390);

  textSize(30);
  stroke("black")
  strokeWeight(5);
  fill("green");
  text("Score: "+ score,530,390);
